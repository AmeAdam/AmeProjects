...
public class NetworkDevice : AggregateRoot<PhysicalAddress>
{
    ...
    public string? PreferredNetworkConfiguration { get; private set;}
    public DhcpState State { get; private set; }

    public NetworkDevice(PhysicalAddress id, string name, IPAddress clientAddress, bool permanent, string preferredNetworkConfiguration)
    {
        Id = id;
        Name = name;
        ...
        PreferredNetworkConfiguration = preferredNetworkConfiguration;
