...
{
    public static class DhcpPacketSerializer
    {
        private const int OPTION_OFFSET = 240;
        private const uint DHCP_OPTIONS_MAGIC_NUMBER = 1669485411;
        public static void Serialize(BinaryWriter writer, DhcpPacket packet)
        {
        ...
        private static byte[] GetDhcpMagicNumber()
        {
        ...
        public static byte[] GetBytes(this DhcpPacket packet)
        {
